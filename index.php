...
{		
	// echo "inside verifyPasswordIsCorrect\n";
	$response = \Slim\Slim::getInstance()->response();
	$response->headers->set('Content-type', 'application/json');	
...
<p>The page you are looking for could not be found. Kirstine Nielsen 100527988</p>
</body></html>
EOT;
echo $template;
});
